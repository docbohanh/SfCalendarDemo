...
class _FunnelSeries {
  ...
  void _findVisibleSeries() {
    ...
    //Setting series type
    currentSeries._seriesType = 'funnel';
  ...
  void _calculateFunnelEmptyPoints(FunnelSeries<dynamic, dynamic> series) {
  ...
  void _processDataPoints() {
    for (_FunnelSeriesBase<dynamic, dynamic> series in visibleSeries) {
      ...
      _calculateFunnelEmptyPoints(currentSeries);
  ...
  void _initializeSizeRatio(_FunnelSeriesBase<dynamic, dynamic> series,
      [bool reverse]) {
  ...
  void _calculateFunnelSegments(Canvas canvas, num pointIndex) {
    _calculateFunnelPathRegion(pointIndex);
    final dynamic currentPoint = currentSeries._renderPoints[pointIndex];
