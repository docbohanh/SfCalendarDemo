...
class _CircularSeries {
  ...
  void _findVisibleSeries() {
    ...
    for (CircularSeries<dynamic, dynamic> series in chart.series) {
      ...
      series._dataPoints = <ChartPoint<dynamic>>[];
        ...
        for (int pointIndex = 0;
          ...
          if (xValue(pointIndex) != null) {
            ...
            series._dataPoints.add(
                ChartPoint<dynamic>(xValue(pointIndex), yValue(pointIndex)));
  ...
  void _calculateCircularEmptyPoints(CircularSeries<dynamic, dynamic> series) {
  ...
  void _processDataPoints() {
    for (CircularSeries<dynamic, dynamic> series in visibleSeries) {
      ...
      _calculateCircularEmptyPoints(currentSeries);
      _findGroupPoints();
    }
  }
  ...
  void _findGroupPoints() {
    ...
    sumOfGroup = 0;
    currentSeries._renderPoints = <ChartPoint<dynamic>>[];
  ...
  void _setPointStyle() {
    ...
    int i = 0;
    for (ChartPoint<dynamic> point in currentSeries._renderPoints) {
